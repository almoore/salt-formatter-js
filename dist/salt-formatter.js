...
.directive('saltFormatter', ['RecursionHelper', 'SaltFormatterConfig', function saltFormatterDirective(RecursionHelper, SaltFormatterConfig) {
  ...
  return {
    templateUrl: 'salt-formatter.html',
    restrict: 'E',
    replace: true,
    scope: {
      json: '=',
